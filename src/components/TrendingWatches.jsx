  ...
  return (
    <div className="flex flex-col h-full max-w-7xl mx-auto pt-10 px-4 sm:px-6 lg:px-0">
      ...
      <div className="bg-white rounded-xl max-w-[1296px] min-h-[524px] mx-auto w-full mt-10 flex flex-col lg:flex-row gap-8 p-3 md:p-10 items-center justify-center">
        {/* Card 1..................................................................... */}
        <div className="max-w-[344px] w-full max-h-[428px] h-full bg-white rounded-[21px] shadow-xl p-4 relative">
        ...
        {/* Card 2................................... */}
        <div className="max-w-[380px] w-full h-[476px] bg-white rounded-[21px] shadow-xl p-4 relative">
        ...
        {/* Card 3.................................... */}
        <div className="max-w-[344px] w-full h-[428px] bg-white rounded-[21px] shadow-xl p-4 px-3 relative overflow-hidden">
